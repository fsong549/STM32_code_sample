...
void ctp_test(void)
{
 ...
 {	 		    
	...
	LCD_ShowString(60,110,200,16,16,"Stored in the 24cxx");
  LCD_ShowString(60,130,200,16,16,"Press S1 to Adjust");	
   	if(tp_dev.touchtype!=0XFF)LCD_ShowString(60,130,200,16,16,"Press S1 to Adjust");//电阻屏才显示
	delay_ms(1500);
	Load_Drow_Dialog();	 	
